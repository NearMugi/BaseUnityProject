...
namespace NAudio.SoundFont
{
    ...
    public class PresetsChunk
    {
        ...
        internal PresetsChunk(RiffChunk chunk)
        {
            ...
            if (header != "pdta")
            {
                throw new NAudio.Utils.InvalidDataException(String.Format("Not a presets data chunk ({0})", header));
            }
            ...
            while ((c = chunk.GetNextSubChunk()) != null)
            {
                switch (c.ChunkID)
                {
                    ...
                    case "shdr":
                        ...
                        break;
                    default:
                        throw new NAudio.Utils.InvalidDataException(String.Format("Unknown chunk type {0}", c.ChunkID));
                }
            }
